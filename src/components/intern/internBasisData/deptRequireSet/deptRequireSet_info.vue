<!--科室要求 - 查看-->
<template>
  <el-table ref="multipleTable" align="center" :data="formValidate.outlineRequires" :height="500" tooltip-effect="dark" style="width: 100%">
    ...
    <el-table-column label="基本要求" align="center" width="180">
    </el-table-column>
    <el-table-column label="轮转周期" align="center" width="100">
    </el-table-column>
  </el-table>
</template>
<script>
