            ...
            <div class="workbench-main-right">
                <div class="personal-infor boder-top-3px">
                    ...
                    <ul class="header-list">
                        <li>
                            <div class="header" style="background: url(../../assets/ambuf/images/news-img02.jpg) 0 0 no-repeat;">
                            </div>
                        </li>
          ...
          <el-row>
            <el-col :span="24">
              <el-alert
                ...
                type="info"
                :closable="false"
                :description="'尊敬的用户'+userInfo.name+','+currAuditStatus"
                show-icon>
              </el-alert>
