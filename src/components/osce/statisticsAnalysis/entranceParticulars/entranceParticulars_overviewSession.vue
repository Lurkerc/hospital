  ...
  <div id="content" ref="content" class="modal" style="height: 100%">
    <div class="overviewSession">
      <div class="overviewSession-content">
        ...
        <p class="overviewSession-lh">及格数: <span class="overviewSession-text">{{data.passNum}}</span></p>
        <p class="overviewSession-lh">及格率: <span class="overviewSession-text">{{data.passPercentage}}</span></p>
