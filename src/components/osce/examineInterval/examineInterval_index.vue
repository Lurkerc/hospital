<template>
  ...
  <div id="interval" ref="interval">
    ...
    <!-- 模态框 增加（add） -->
    <Modal v-model="selectModal" height="200" title="对话框标题" class-name="vertical-center-modal" :width="320">
      <modal-header slot="header" :content="contentHeader.selectId"></modal-header>
      <select-type v-if="selectModal" @cancel="cancel" @select="selectSceneType" :operaility-data="operailityData"></select-type>
      <div slot="footer"></div>
    </Modal>
    <!-- 模态框 删除（del） -->
