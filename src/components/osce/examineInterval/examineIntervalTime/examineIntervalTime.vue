  ...
  <div class="examineIntervalTime">
    ...
    <div class="exContent">
      ...
      <div class="exRightBody">
        ...
        <template v-else>
          ...
          <div id="content" ref="content" style="position: absolute;left: 10px;right: 0;top: 45px;bottom: 10px;">
            <student-time v-if="headerList[0]" :height="dynamicHt" :sceneTypes="sceneType" v-show="active === 'student'" :headerList="headerList"
            ...
            <student-time v-if="spHeaderList[0]" :height="dynamicHt" v-show="active === 'sp'" :headerList="spHeaderList" :tableList="spTableList"></student-time>
      ...
      <el-dialog :title="button.viewTableTime.title" size="full" :modal="false" :visible.sync="viewTableTimeModal" :before-close="closeViewTable">
        <template>
          <student-time v-if="active === 'student' && viewTableTimeModal" :height="dialogContHt" :sceneTypes="sceneType" :headerList="headerList"
            :tableList="tableList"></student-time>
