  ...
  <div id="content" ref="content" class="modal">
    <el-form ref="formValidate" :inline="true"  class="form-inline lose-margin" label-width="90px" >
      <el-form-item label="姓名" prop="userName">
        <el-input v-model="formValidate.userName" placeholder="姓名"></el-input>
      </el-form-item>
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template scope="scope">
              ...
              <el-button size="small" @click="medicalAudit(scope.row)">体检报告审核</el-button>
              <el-button size="small" @click="expenseAudit(scope.row)">报销审核</el-button>
              <el-button size="small" @click="reported(scope.row)">上报</el-button>
              <el-button size="small" @click="upload(scope.row)">上传资料</el-button>
              <el-button size="small" @click="expense(scope.row)">报销申请</el-button>
            </template>
          </el-table-column>
          <el-table-column
            align="center"
    ...
    <div>
      ...
      <Modal
        ...
        <medical-audit v-if="medicalAuditModal" @cancel="cancel" @medicalAudit="subCallback" :operaility-data="operailityData"></medical-audit>
        <div slot="footer"></div>
      </Modal>
      <!--上报弹窗-->
      <Modal
      ...
      <Modal
        ...
        <expense v-if="expenseModal"  @expense="subCallback" @cancel="cancel" :operaility-data="operailityData"></expense>
        <div slot="footer"></div>
      </Modal>
      <!---->
      <!--职业防护弹窗-->
    ...
    data() {
      ...
      //转换暴露状态
        ...
        listMessTitle:{
          ...
          ajaxParams:{
            url:'occupationalExposureAudit/list',
            params:{},
          }
        },
