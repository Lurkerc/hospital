      ...
      <el-row >
        <el-col :span="8" :offset="2">
          <el-form-item  label="报销金额:" class="feildFontweight">
            <el-input type="number" v-model.number="formValidate.amountMoney"> </el-input>
          </el-form-item>
        </el-col >
    ...
    data (){
      return{
        ...
        addMessTitle:{
          ...
          ajaxError:'ajaxError',
          ajaxParams:{
            url:'occupationalExposureAudit/reimbursement/add',
            method:'post'
          }
        },
        ...
        editMessTitle:{
          ...
          ajaxError:'ajaxError',
          ajaxParams:{
            url:'occupationalExposureAudit/reimbursement/modify/'+this.operailityData.reimbursementId,
            method:'put'
          }
        },
        isAdd:true, //是否是新建
      ...
      * @param isLoadingFun boolean  form表单验证是否通过*/
      reportedEvent(isLoadingFun){
        ...
        if(isSubmit){
          ...
          messTitle = !!this.isAdd ?  this.addMessTitle : this.editMessTitle;
          messTitle.ajaxParams.data=this.getFormData(this.data);
