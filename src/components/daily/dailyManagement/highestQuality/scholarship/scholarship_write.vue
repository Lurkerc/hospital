    ...
    <el-form ref="formValidate"  class="demo-form-inline " label-width="90px" >
      ...
      <fieldset class="layui-elem-field">
        ...
        <div class="layui-field-box">
          ...
          <el-row class="table-back-two-d">
            <el-col :span="11" :offset="1">
              必修课   <el-input v-model.number="formValidate.courseNum"  type="number" style="width: 50px;"></el-input>  门，
              其中几个以上   <el-input v-model.number="formValidate.passNum"  type="number" style="width: 50px;"></el-input> 门
            </el-col>
            <el-col :span="10" >
              如是，排名  <p v-show="+formValidate.isComprehensive" style="display: inline-block;"><el-input   type="number" v-model.number="score.compositeRanking" style="width: 50px;"></el-input>
                  ...
                  <el-table-column
                    ...
                    <template scope="scope">
                      <el-button
                        size="small"
                        type="info"
                        @click="removeAward(scope.$index,scope.row)">删除
                      </el-button>
                      <el-button
                        size="small"
                        type="info"
                        v-if="scope.$index+1==formValidate.awardList.length"
