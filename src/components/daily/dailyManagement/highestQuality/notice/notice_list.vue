  ...
  <div id="nosocomial" ref="nosocomial" class="modal">
    <div class="add-remove">
      <el-form  ref="formValidate" label-width="100px" class="demo-ruleForm">
        <el-row >
          <el-col :span="6" >
            <el-button  class="but-col"  @click="publish"  type="primary">发布公告</el-button>
            <el-button  class="but-col"    type="primary">导出excel</el-button>
            <el-button  class="but-col"  @click="selected"  type="primary">获选</el-button>
          </el-col>
    ...
    <div style="margin: 10px;">
      ...
      <div>
        ...
        <Modal
          ...
          <publish v-if="publishModal"  @cancel="cancel" @publish="subCallback" :operaility-data="operailityData"></publish>
          <div slot="footer"></div>
        </Modal>
        <!---->
        <!--查看弹窗-->
        ...
        <Modal
          ...
          <operate v-if="selectedModal" :type="'selected'" :messTitle="selectedMessTitle" :operateUrl="selectedUrl" @operate="subCallback" @cancel="cancel" :operaility-data="operailityData"></operate>
          <div slot="footer"></div>
        </Modal>
        <!---->
...
<script >
  ...
  //引入--查看--组件
  import show from './notice_view.vue';
