    ...
    <div class="add-remove">
      <el-row >
        <el-col :span="20" :offset="2">
          参投人数：<span class="show-count">{{voteData.totalNum}}</span>人  &nbsp; &nbsp; &nbsp;
          已投人数：<span class="show-count">{{voteData.voteNum}}</span>人 &nbsp; &nbsp; &nbsp;
          未投人数：<span class="show-count">{{voteData.noVoteNum}}</span>人 &nbsp; &nbsp; &nbsp;
        </el-col>
      </el-row >
    </div>
    <div
