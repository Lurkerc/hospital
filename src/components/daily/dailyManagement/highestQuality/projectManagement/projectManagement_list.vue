...
<script >
  /*当前组件必要引入*/
  //引入--修改--组件
  import edit from "./projectManagement_edit.vue";
  //引入--查看--组件
  import show from "./projectManagement_view.vue";
  //引入--添加--组件
  import add from "./projectManagement_add.vue";
  ...
  export default{
    ...
    data() {
      return {
        deleteUrl:'appraising/project/remove',
        //查询表单
