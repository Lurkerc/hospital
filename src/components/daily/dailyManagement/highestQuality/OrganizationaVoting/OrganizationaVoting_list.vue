    ...
    <div style="margin: 10px;">
      ...
      <div>
        ...
        <Modal
          ...
          <operate v-if="publishModal" :type="'publish'" :operateUrl="publishUrl" @operate="subCallback" @cancel="cancel" :operaility-data="operailityData"></operate>
          <div slot="footer"></div>
        </Modal>
        <!---->
        <!--撤销弹窗-->
        <Modal
          ...
          :width="500">
          <modal-header slot="header" :content="removeId"></modal-header>
          <operate v-if="revocationModal" :type="'revocation'" :operateUrl="revocationUrl" @operate="subCallback" @cancel="cancel" :operaility-data="operailityData"></operate>
          <div slot="footer"></div>
        </Modal>
        <!---->
      </div>
...
<script >
  /*当前组件必要引入*/
  //引入--修改--组件
  import edit from "./OrganizationaVoting_edit.vue";
  //引入--查看--组件
  ...
  export default{
    ...
    data() {
      return {
        isRoot:true,
        //查询表单
        publishUrl:'appraising/vote/project/publish',     //发布
        deleteUrl:'appraising/vote/project/delete',    //删除
        revocationUrl:'appraising/vote/project/unpublish',  //撤销
        ...
        listMessTitle:{
          ...
          ajaxParams:{
            url:'appraising/vote/project/list',
            params:{}
          }
        },
