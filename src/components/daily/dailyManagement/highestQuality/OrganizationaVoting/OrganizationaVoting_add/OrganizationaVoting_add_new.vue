...
<template>
  ...
  <div>
    <el-form ref="formValidate"  class="demo-form-inline" label-width="90px">
      ...
      <el-row >
        <el-col :span="17" :offset="2">
          <el-form-item label="时间:" class="feildFontweight">
            <el-date-picker
                ...
                <el-row>
                  <el-col :span="24">
                    <div class="grid-content-ptop">
                      ...
                      <el-select filterable  v-show="formValidate.voterScope =='DEP'" v-model="formValidate.depId"  style="margin-left: 10px" filterable placeholder="请选择">
...
<script>
  let Util=null;
  export default {
      props:['recommendPerson','selectProjectId'],
    data (){
      return{
        desc:'',
        options: [{
        ...
        addMessTitle:{
          ...
          ajaxError:'ajaxError',
          ajaxParams:{
            url:'appraising/vote/project/add',
            method:'post'
          }
        },
      }
    ...
    methods:{
      ...
      listenSubEvent(isLoadingFun){
        ...
        if(isSubmit){
          ...
          isLoadingFun(true);
          this.addMessTitle.ajaxParams.data=this.conductFormValidate(this.getFormData(this.formValidate));
