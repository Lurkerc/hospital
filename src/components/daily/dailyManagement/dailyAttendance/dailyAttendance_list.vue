        ...
        <el-table-column
          ...
          <el-table-column
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template  scope="scope">
                {{commutator(scope.row.clockList[0].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[1].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[2].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[3].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[4].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[5].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[6].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[7].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[8].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[9].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[10].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[11].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[12].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[13].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[14].type)}}
              </template>
            </el-table-column>
        ...
        <el-table-column
          ...
          <el-table-column
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[15].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[16].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[17].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[18].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[19].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[20].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[21].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[22].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[23].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[24].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[25].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[26].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[27].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[28].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[29].type)}}
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              show-overflow-tooltip>
              <template scope="scope">
                {{commutator(scope.row.clockList[30].type)}}
              </template>
            </el-table-column>
