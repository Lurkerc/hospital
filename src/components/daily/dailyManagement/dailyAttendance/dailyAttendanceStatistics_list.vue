    ...
    >
      <el-table
        ...
        <el-table-column
          ...
          <template scope="scope">
            <el-input type="number" min="0" max="31"  @focus="saveCell(scope.row.workAttendance)" @blur="valuationCell(scope.row,'workAttendance')" v-model.number="scope.row.workAttendance" placeholder="0"></el-input>
          </template>
        </el-table-column>
        <el-table-column
          ...
          show-overflow-tooltip>
          <template scope="scope">
            <el-input type="number" min="0" max="31"  @focus="saveCell(scope.row.compassionateLeave)" @blur="valuationCell(scope.row,'compassionateLeave')" v-model.number="scope.row.compassionateLeave" placeholder="0"></el-input>
          </template>
        </el-table-column>
        <el-table-column
          prop="sickLeave"
          ...
          show-overflow-tooltip>
          <template scope="scope">
            <el-input type="number" min="0" max="31"  @focus="saveCell(scope.row.sickLeave)" @blur="valuationCell(scope.row,'sickLeave')" v-model.number="scope.row.sickLeave" placeholder="0"></el-input>
          </template>
        </el-table-column>
        <el-table-column
          prop="marriageLeave"
          ...
          show-overflow-tooltip>
          <template scope="scope">
            <el-input type="number" min="0" max="31"  @focus="saveCell(scope.row.marriageLeave)" @blur="valuationCell(scope.row,'marriageLeave')" v-model.number="scope.row.marriageLeave" placeholder="0"></el-input>
          </template>
        </el-table-column>
        <el-table-column
          prop="otherLeave"
          ...
          show-overflow-tooltip>
          <template scope="scope">
            <el-input type="number" min="0" max="31"  @focus="saveCell(scope.row.otherLeave)" @blur="valuationCell(scope.row,'otherLeave')" v-model.number="scope.row.otherLeave" placeholder="0"></el-input>
          </template>
        </el-table-column>
        <el-table-column
          prop="absenteeism"
          ...
          show-overflow-tooltip>
          <template scope="scope">
            <el-input type="number" min="0" max="31"   @focus="saveCell(scope.row.absenteeism)" @blur="valuationCell(scope.row,'absenteeism')"  v-model.number="scope.row.absenteeism" placeholder="0"></el-input>
          </template>
        </el-table-column>
        <el-table-column
          prop="notes"
          ...
          show-overflow-tooltip>
          <template scope="scope">
            <el-input type="number"  max="31" @focus="saveCell(scope.row.notes)" @blur="valuationCell(scope.row,'notes')" v-model="scope.row.notes" placeholder="请输入"></el-input>
          </template>
        </el-table-column>
      </el-table>
