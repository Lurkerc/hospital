...
<template>
  <div id="content" ref="content" class="modal">
    ...
    <div class="add-remove">
          <el-button  class="but-col" @click="noGrant" type="primary">不发放</el-button>
          <el-button  class="but-col" @click="grant" type="primary">发放</el-button>
          <el-button  @click="setBenefit" type="primary">津贴设置</el-button>
    </div>
    <div
      id="myTable"
      ref="myTable"
    ...
    >
      <el-table
        ...
        <el-table-column
          ...
          show-overflow-tooltip>
          <template scope="scope">
            {{scope.row.provideStatus=='ZC'?'正常':'不发放'}}
          </template>
        </el-table-column>
      </el-table>
    </div>
    <div style="margin: 10px;">
      ...
      <Modal
        ...
        height="200"
        v-model="noGrantModal"
        title="对话框标题"
        class-name="vertical-center-modal"
        :loading="loading"
        :width="500">
        <modal-header slot="header" :content="noGrantId"></modal-header>
        <operate v-if="noGrantModal" :type="'noGrant'"  :operateData="noGrantData"    @operate="subCallback" @cancel="cancel" :operaility-data="operailityData"></operate>
        <div slot="footer"></div>
      </Modal>
      <!---->
      <!--发放弹窗-->
      <Modal
        ...
        <operate v-if="grantModal" :type="'grant'" :operateData="grantData"  @operate="subCallback" @cancel="cancel" :operaility-data="operailityData"></operate>
        <div slot="footer"></div>
      </Modal>
      <!---->
    </div>
  ...
  export default{
    ...
    methods: {
      ...
      updateListData(responseData){
       this.tableData1 = responseData.data
