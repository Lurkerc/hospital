    ...
    data (){
      return{
        ...
        "data":{
          ...
          "depId":"10",           //科室Id
          "depName":"呼吸科",      //科室名称
          "provideMonth":"2016-01",   //发放年月
          "provideAmount":"450",      //发放金额
          "provideStatus":"zc",       //发放状态
          "attendance": {            //考勤统计对象
              "workAttendance":"2",     //实际出勤
              "workAndRest":"2",        //半工半休
              "compassionateLeave":"2", //事假
              "sickLeave":"2",          //病假
              "marriageLeave":"2",      //婚假
              "funeralLeave":"2",       //丧假
              "otherLeave":"2",         //其他
          ...
          "evaluate":"good",            //老师评价
          "score":"100",                //考试成绩
          "examinationResult":"good",   //考核结果
          "rewardsAndPunishments":[    //奖惩情况
            {
              "rewardAndPunishmentType":"0",  //奖惩类型
              "rewardAndPunishmentDescribe":"测试"  //事项说明
            }
          ],
          "record":[                    //轮转记录统计对象
            {
