            ...
            <el-row v-for="(item,index) in YJS" :key="index">
              <el-col :span="3" >
                <el-form-item  prop="name" label-width="0">
                  <el-input type="number" v-model.number="item.calculationMethod.minScore" min="0"  placeholder="请输入"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="7" >
                <el-form-item  prop="name" label="< 综合评分 >"  label-width="120px">
                  <el-input type="number" min="0"  v-model.number="item.calculationMethod.maxScore" placeholder="请输入"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="4" >
                <el-form-item  prop="name" label="硕士:"  label-width="50px">
                  <el-input type="number" min="0" v-model.number="item.calculationMethod.master" placeholder="请输入"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="2" >
              ...
              <el-col :span="4" >
                <el-form-item  prop="name" label="博士:"  label-width="50px">
                  <el-input type="number" min="0" v-model.number="item.calculationMethod.doctor"  placeholder="请输入"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="2" >
                <el-form-item  prop="name" label="元/季度"  label-width="60px"></el-form-item>
              ...
              <el-col :span="2" >
                <el-button v-show="index!=0" type="primary" @click="removeYjs(index)" icon="close"></el-button>
              </el-col>
      </el-row >
            <el-button  type="primary" @click="addYjs"  >增加</el-button>
            ...
            <el-row >
              <el-col :span="5" >
                <el-form-item  prop="name" label="全额发放:"  label-width="75px">
                  <el-input type="number" v-model.number="ZYY.calculationMethod.amount" min="0"  placeholder="请输入"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="2" >
              ...
              <el-col :span="5" >
                <el-form-item  prop="name" label="旷工扣发:"  label-width="75px">
                  <el-input type="number" min="0"  v-model.number="ZYY.calculationMethod.absence"  placeholder="请输入"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="2" >
              ...
              <el-col :span="5" >
                <el-form-item  prop="name" label="请假扣发:"  label-width="75px">
                  <el-input type="number" min="0"   v-model.number="ZYY.calculationMethod.leave"  placeholder="请输入"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="2" >
                <el-form-item  prop="name" label="元/天"  label-width="60px"></el-form-item>
            ...
            <el-row >
              <el-col :span="6" >
                <el-form-item  prop="name" label="考核等级   优:"  label-width="100px">
                  <el-input type="number" min="0"  v-model.number="JXS.calculationMethod.good"  placeholder="请输入"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="2" >
                <el-form-item  prop="name" label="元/月"  label-width="60px"></el-form-item>
              ...
              <el-col :span="5" >
                <el-form-item  prop="name" label="良:"  label-width="35px">
                  <el-input type="number" min="0"   v-model.number="JXS.calculationMethod.well" placeholder="请输入"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="2" >
                <el-form-item  prop="name" label="元/月"  label-width="60px"></el-form-item>
              ...
              <el-col :span="5" >
                <el-form-item  prop="name" label="差:"  label-width="35px">
                  <el-input type="number" min="0"  v-model.number="JXS.calculationMethod.bad"  placeholder="请输入"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="2" >
                <el-form-item  prop="name" label="元/月"  label-width="60px"></el-form-item>
