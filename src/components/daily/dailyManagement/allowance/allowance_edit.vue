  ...
  <div >
    <el-form ref="formValidate"    class="demo-form-inline" label-width="80px" >
     ...
     <!--研究生-->
      ...
      <el-row class="lose-margin2">
        <el-col :span="20" :offset="2">
          <p ><span class="text-w" >发放月份：</span><span>{{converter(data.provideMonth)}}</span></p>
        </el-col >
      </el-row >

      <el-row class="lose-margin2">
        <el-col :span="5" :offset="2">
            <el-form-item  prop="name" label="发放金额:" >
              <el-input  v-model.number="formValidate.provideAmount" type="number" placeholder="请输入"></el-input>
            </el-form-item>
        </el-col >
      </el-row >
      <!---->
...
//        let role = 'zyy';
      return{
        ...
        editMessTitle:{
          ...
          ajaxParams:{
            url:'allowance/modify/'+this.operailityData.id,
            method:'put',
          }
        },
        ...
        listMessTitle:{
          ...
          ajaxParams:{
            url:'allowance/get/'+this.operailityData.userType.toLocaleLowerCase()+'/'+this.operailityData.id,
          }
        }
      }
    },
    ...
    methods:{
      ...
      SuccessGetCurrData(responseData){
          ...
          this.formValidate.provideAmount = responseData.data.provideAmount
      },
      /*
       * 当前组件发送事件给父组件
