...
<template>
  <div>
    <el-row>
      <el-col>
        <h3>住院医规培报名起止时间：</h3>
        <el-form :inline="true" ref="rst" :model="rst" :rules="rdyEnrollSet_rst">
          <el-form-item label="住院医规培报名开始时间" prop="configValue">
            <el-date-picker v-model="rst.configValue" type="date" :editable="false" placeholder="选择日期"></el-date-picker>
          </el-form-item>
        </el-form>
        <el-form :inline="true" ref="ret" :model="ret" :rules="rdyEnrollSet_ret">
          <el-form-item label="住院医规培报名结束时间" prop="configValue">
            <el-date-picker v-model="ret.configValue" type="date" :editable="false" placeholder="选择日期"></el-date-picker>
          </el-form-item>
        </el-form>
      </el-col>
    </el-row>
