...
<template>
  <div id="content" ref="content" class="modal">
    ...
    <Modal
      ...
      <operate v-if="passModal" :type="'pass'" :operate-url="url.tutorAudit.path" :methods="'post'" :operateData="passData" @cancel="cancel" @operate="subCallback"  ></operate>
      <div slot="footer"></div>
    </Modal>
    ...
    <Modal
      ...
      <operate v-if="rejectModal" :type="'reject'" :operate-url="url.tutorAudit.path" :operateData="rejectData" :methods="'post'"  @cancel="cancel" @operate="subCallback"  ></operate>
      <div slot="footer"></div>
    </Modal>
  </div>
</template>
