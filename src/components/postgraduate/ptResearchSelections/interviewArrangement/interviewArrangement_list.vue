...
<template>
  <div id="content" ref="content">
    ...
    <div style="margin-bottom: 20px;">
      <el-button v-show="identify!='JYC'" v-if="isPass" type="primary" @click="arrange">安排面试</el-button>
      <el-button v-show="identify!='JYC'" v-else type="primary" @click="" :disabled="true">安排面试</el-button>
    </div>
      ...
      >
        <el-table
          ...
          <el-table-column
            ...
            width="100">
            <template scope="scope">
              <el-button :disabled="!scope.row.status || scope.row.status == 'NOINTERVIEW'" size="small" @click="show(scope.row)">查看</el-button>
            </template>
          </el-table-column>
          <el-table-column
            align="center"
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      // 是否允许参与选择
      canTodo(row) {
        return row.status == 'UNPUBLISH' || !row.status ;
      },
      // 增加回调
