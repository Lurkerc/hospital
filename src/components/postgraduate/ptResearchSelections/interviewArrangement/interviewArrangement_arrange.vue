        ...
        <el-row>
          ...
          <el-col :offset="2">
            <el-form-item label="面试地点：" prop="address">
              <el-input style="width: 80%" v-model="formValidate.address" type="textarea" :autosize="{ minRows: 1, maxRows: 6}" placeholder="请填写面试地点" ></el-input>
            </el-form-item>
          </el-col>

          <el-col :offset="2">
            <el-form-item label="备注：" prop="remarks">
              <el-input style="width: 80%" v-model="formValidate.remarks" type="textarea" :autosize="{ minRows: 2, maxRows: 4}"></el-input>
            </el-form-item>
          </el-col>
...
<script>
    ...
    export default {
        ...
        methods: {
          ...
          //转换时间格式
          handleStartTime(value){
            this.formValidate.interviewTime = value;
          },
          /*
           * 重置当前表单
           * */
