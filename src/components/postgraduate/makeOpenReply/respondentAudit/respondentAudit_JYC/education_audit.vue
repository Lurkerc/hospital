<template>
  ...
  <div>
    <el-form :model="formValidate" v-for="item in 1" :key="item" :rules="rules" ref="formValidate"    class="demo-form-inline" label-width="90px" >
      <baseInfo :peport="peport"  :view="view"  :operailityData="getData">
