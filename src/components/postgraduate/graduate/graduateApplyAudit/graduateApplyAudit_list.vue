    ...
    <el-form  :model="formValidate" :rules="rules" ref="formValidate" inline label-width="100px">
      ...
      <div v-show="searchMore" ref="searchMore">
        ...
        <el-form-item label="状态" prop="status" >
          ...
          <el-select v-else-if="typeView=='JYS'" filterable  v-model="formValidate.status" placeholder="请选择">
          ...
          <el-select v-else-if="typeView=='JYC'" filterable  v-model="formValidate.status" placeholder="请选择">
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template scope="scope">
              ...
              <el-button type="primary" size="small" @click="audit(scope.row)" :disabled="typeView =='DS' && scope.row.status != 'DSH' || typeView =='JYS' && scope.row.status != 'DSTG' || typeView =='JYC' && scope.row.status != 'JYSTG'">审核</el-button>
