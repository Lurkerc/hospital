...
<template>
  <div id="content" ref="content" class="modal">
    <el-form  :model="formValidate" :rules="rules" ref="formValidate" inline label-width="100px">
      <el-row style="margin-bottom:0">
        ...
        <el-col :span="10">
          ...
          <el-button type="info" >导出组织信息</el-button>
    ...
    <Modal
      ...
      <remove  v-if="removeModal" :delete-url="url.retestRemoves.path" @remove="subCallback" @cancel="cancel" :operaility-data="operailityData"></remove>
...
<script>
  ...
  //引入--修改--组件
  import edit from "./ptOrganizationReexamine_edit.vue";
    ...
    data() {
      return {
        ...
        listMessTitle:{
          ...
          ajaxParams:{
            url:url.retestList.path,
            method:url.retestList.method,
            params:{}
          }
        },
        /*--按钮button--*/
