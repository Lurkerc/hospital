...
<script>
  ...
  import basicEdit from '../../../teach/teacherResManagement/normCourse/basic/basic_web_edit'; // 授课基本信息
  ...
  export default {
    ...
    methods: {
      ...
      getSaveData(auditStatus) {
        ...
        return getWebCourse(theData.course, theData.evaluate, theData.planDtoList, auditStatus)
      },
    },
