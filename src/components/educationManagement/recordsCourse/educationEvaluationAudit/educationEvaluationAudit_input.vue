  ...
  <div>
    ...
    <table class="el-table oeawInputTable">
      ...
      <tr>
        ...
        <td rowspan="2">
          <div class="cell">
            <el-checkbox v-model="formValidate.inspectionLevel" true-label="IN"></el-checkbox>
          </div>
        </td>
        <td rowspan="2">
          <div class="cell">
            <el-checkbox v-model="formValidate.inspectionLevel" true-label="BAD"></el-checkbox>
          </div>
        </td>
        <!--<td align="center" colspan="3">-->
          <!--<div class="cell">-->
    ...
    data() {
      return {
        ...
        formValidate: {
          ...
          comments: '', // 评语
          inspectionLevel: 'GOOD', // 考核等级 GOOD好|IN中|BAD差
          evaluationUserName:'',
        },
        //收受红包回扣信息
