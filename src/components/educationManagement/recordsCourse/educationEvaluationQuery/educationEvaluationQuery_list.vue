      ...
      <el-table
        ...
        <el-table-column label="劳动纪律" show-overflow-tooltip align="center">
          <el-table-column prop="lateArrivalTimes" label="迟到" align="center">
            <template scope="scope">
              <el-input v-model="scope.row.lateArrivalTimes"></el-input>
            </template>
          </el-table-column>

          <el-table-column prop="leaveEarlyTimes" label="早退" align="center">
            <template scope="scope">
              <el-input v-model="scope.row.leaveEarlyTimes"></el-input>
            </template>
          </el-table-column>

          <el-table-column prop="askLeaveDays" label="请假" align="center">
            <template scope="scope">
              <el-input v-model="scope.row.askLeaveDays"></el-input>
            </template>
          </el-table-column>

          <el-table-column prop="minerDays" label="旷课" align="center">
            <template scope="scope">
              <el-input v-model="scope.row.minerDays"></el-input>
            </template>
          </el-table-column>

          <el-table-column prop="otherBreachDiscipline" label="其他" align="center">
            <template scope="scope">
              <el-input v-model="scope.row.otherBreachDiscipline"></el-input>
            </template>
          </el-table-column>
        </el-table-column>
        ...
        <el-table-column label="医疗质量" show-overflow-tooltip align="center">
          <el-table-column prop="classRecords" label="丙级病历" align="center">
            <template scope="scope">
              <el-input v-model="scope.row.classRecords"></el-input>
            </template>
          </el-table-column>

          <el-table-column prop="unqualifiedPrescription" label="不合格处方" align="center">
            <template scope="scope">
              <el-input v-model="scope.row.unqualifiedPrescription"></el-input>
            </template>
          </el-table-column>

          <el-table-column prop="seriousMedicalErrors" label="严重医疗差错" align="center">
            <template scope="scope">
              <el-input v-model="scope.row.seriousMedicalErrors"></el-input>
            </template>
          </el-table-column>

          <el-table-column prop="medicalAccident" label="医疗事故" align="center">
            <template scope="scope">
              <el-input v-model="scope.row.medicalAccident"></el-input>
            </template>
          </el-table-column>
        </el-table-column>
        ...
        <el-table-column label="医德医风" show-overflow-tooltip align="center">
          ...
          <el-table-column label="收红包情况" align="center">
            ...
            <el-table-column prop="hasRedEnvelope" label="无" align="center">
              <template scope="scope">
                <el-radio v-model="scope.row.hasRedEnvelope" label="N" @click.native="clearInputVal(scope.row,'hasRedEnvelope','redEnvelopeCount','redEnvelopeAmount')"><span></span></el-radio>
            ...
            <el-table-column label="有" align="center">
              ...
              <el-table-column prop="redEnvelopeCount" label="次数" align="center">
                <template scope="scope">
                  <el-input v-model="scope.row.redEnvelopeCount" @input="changeCheckBoxVal(scope.row,'hasRedEnvelope')"></el-input>
                </template>
              </el-table-column>

              <el-table-column prop="redEnvelopeAmount" label="金额" align="center">
                <template scope="scope">
                  <el-input v-model="scope.row.redEnvelopeAmount" @input="changeCheckBoxVal(scope.row,'hasRedEnvelope')"></el-input>
                </template>
              </el-table-column>
          ...
          <el-table-column label="收受医药回扣情况" align="center">
            ...
            <el-table-column prop="hasRebate" label="无" align="center">
              <template scope="scope">
                <el-radio v-model="scope.row.hasRebate" label="N" @click.native="clearInputVal(scope.row,'hasRebate','rebateCount','rebateAmount')"><span></span></el-radio>
            ...
            <el-table-column label="有" align="center">
              ...
              <el-table-column prop="rebateCount" label="次数" align="center">
                <template scope="scope">
                  <el-input v-model="scope.row.rebateCount" @input="changeCheckBoxVal(scope.row,'hasRebate')"></el-input>
                </template>
              </el-table-column>

              <el-table-column prop="rebateAmount" label="金额" align="center">
                <template scope="scope">
                  <el-input v-model="scope.row.rebateAmount" @input="changeCheckBoxVal(scope.row,'hasRebate')"></el-input>
                </template>
              </el-table-column>
          ...
          <el-table-column prop="patientComplaints" label="病人投诉" align="center">
            <template scope="scope">
              <el-input v-model="scope.row.patientComplaints"></el-input>
            </template>
          </el-table-column>
          ...
          <el-table-column label="对待病人态度" align="center">
            ...
            <el-table-column prop="attitudeTowardPatient" label="好" align="center">
              <template scope="scope">
                <el-radio v-model="scope.row.attitudeTowardPatient" label="GOOD"><span></span></el-radio>
              </template>
            </el-table-column>

            <el-table-column prop="attitudeTowardPatient" label="中" align="center">
              <template scope="scope">
                <el-radio v-model="scope.row.attitudeTowardPatient" label="IN"><span></span></el-radio>
              </template>
            </el-table-column>

            <el-table-column prop="attitudeTowardPatient" label="差" align="center">
              <template scope="scope">
                <el-radio v-model="scope.row.attitudeTowardPatient" label="BAD"><span></span></el-radio>
              </template>
            </el-table-column>
        ...
        let opt = {
          ajaxSuccess:res=>{
            if (res.data && res.data.length){
              this.queryTreeByManager = this.getQTBObj(res.data);
              this.depIndex = 0;
