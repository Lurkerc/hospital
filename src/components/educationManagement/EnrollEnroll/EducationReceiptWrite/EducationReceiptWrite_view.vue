    ...
    <div class="engageNotice-content" style="height: 90%">
      ...
      <el-row>
        <el-col :span="22" :offset="2" style="text-indent: 2em">
          <div class="cal-schoolTit">进修单位：<div class="myBtLine">{{showData.workName}}</div>，进修时间：<div class="myBtLine">{{showData.studyTime=='HALFTYEAR'?'半年':'一年'}}</div>，报到时间：<div class="myBtLine">{{showData.checkInTime}}</div> 需要交款 <div class="myBtLine">{{showData.paymentAmount}}</div> 元。</div>
        </el-col>
      </el-row>
      <br />
      <el-row>
