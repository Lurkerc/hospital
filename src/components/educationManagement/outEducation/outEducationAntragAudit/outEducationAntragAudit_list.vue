...
<template>
  <div ref="content">
      ...
      <el-table align="center" :height="dynamicHt" :context="self" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column label="操作" align="center" width="230">
          <template scope="scope">
            ...
            <!-- 上报才可审核 -->
            <el-button size="small" type="warning" @click="add(scope.row)" :disabled="['1'].indexOf(scope.row.status) === -1">审核</el-button>
            <!-- 审核通过才可进行费用报销审核 -->
    ...
    <Modal
      ...
      <operate v-if="passModal" :type="'pass'" :operate-url="auditUrl" :methods="'post'" :operateData="passData" @cancel="cancel" @operate="subCallback" :operaility-data="operailityData" ></operate>
      <div slot="footer"></div>
    </Modal>
    ...
    <Modal
      ...
      <operate v-if="rejectModal" :type="'reject'" :operate-url="auditUrl" :operateData="rejectData" :methods="'post'"  @cancel="cancel" @operate="subCallback" :operaility-data="operailityData" ></operate>
      <div slot="footer"></div>
    </Modal>
  </div>
</template>
