  ...
  <div>
    ...
    <el-row style="margin-top: 20px;">
      <el-col :span="6" :offset="6" align="center">
        <el-button type="info" @click="save(4)">保存</el-button>
      </el-col>
      <el-col :span="6" align="center">
        <el-button type="success" @click="save(5)">上报</el-button>
      </el-col>
    </el-row>
  </div>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        addMessTitle: {
          type: this.operailityData.status == 4 ? 'edit' : 'add',
          successTitle: this.operailityData.status == 4 ? '修改成功!' : '添加成功!',
          errorTitle: this.operailityData.status == 4 ? '修改失败!' : '添加失败!',
