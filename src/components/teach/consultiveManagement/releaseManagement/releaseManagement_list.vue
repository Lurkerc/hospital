      ...
      <div style="margin: 10px;">
        ...
        <div>
          ...
          <Modal
            ...
            <edit v-if="editModal"   @cancel="cancel"  @edit="subCallback"  :url="url" :operaility-data="operailityData"></edit>
            <div slot="footer"></div>
          </Modal>
          <!---->
          <!--增加弹窗-->
          ...
          <Modal
            ...
            <remove v-if="removeModal" :deleteUrl="url.noticeRemove" @remove="subCallback" @cancel="cancel" :operaility-data="operailityData"></remove>
            <div slot="footer"></div>
          </Modal>
          <!--发布弹窗-->
          <Modal
