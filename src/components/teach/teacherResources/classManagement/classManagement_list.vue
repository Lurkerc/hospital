    ...
    <div>
      ...
      <div id="myTable" ref="myTable">
        <el-table align="center" :height="dynamicHt" :context="self" :data="tableData1" tooltip-effect="dark" highlight-current-row
          ...
          <el-table-column align="center" prop="name" label="学期" width="120">
          </el-table-column>
          <el-table-column prop="identify" label="科室" width="120">
          </el-table-column>
          <el-table-column prop="remark" label="姓名" align="center">
          </el-table-column>
          <el-table-column prop="type" label="课程类型" width="120">
          </el-table-column>
          <el-table-column prop="type" label="总课时" width="120">
          </el-table-column>
          <el-table-column prop="type" label="应付" width="120">
          </el-table-column>
