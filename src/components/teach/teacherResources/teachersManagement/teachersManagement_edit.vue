          ...
          <el-row :gutter="10">
              ...
              <el-row :gutter="10" class="table-back-one">
                ...
                <el-col :span="8" >
                  <el-form-item label="毕业学校：" prop="school" >
                    <el-select v-model="formValidate.schoolId" placeholder="请选择">
                       <select-option  :unAll="true" :type="'school'"></select-option>
                    </el-select>
                  </el-form-item>
                </el-col>
              </el-row >
            ...
            <el-col :span="5" class="table-back-header" >
              <div style="text-align: center">
                <img v-if="showImg" class="headerUrl" @mouseover="showUploadHeader" :src="imgSrc" style="width: 100%" />
                <span @mouseout="hideUploadHeader"><up-header v-if="!showImg" @upladSuccess="setUploadHeaderSuccessUrl" :actionUrl="uploadHeaderUrl"></up-header></span>
              </div>
            </el-col>
  ...
  export default {
    ...
    methods:{
      ...
      SuccessGetCurrData(responseData){
        ...
        this.selectOptions.value = this.formValidate.school;
      },
