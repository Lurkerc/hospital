...
<script>
  /*引入查看的子组件*/
  //  引入--基本情况--组件
  import basic from './teachersManagement_view/teachersManagement_view_basic.vue';
  //  引入--学历信息--组件
  import education from './teachersManagement_view/teachersManagement_view_education.vue';
  //  引入--工作经历--组件
  import workExperience from './teachersManagement_view/teachersManagement_view_workExperience.vue';
  //  引入--专业技术职称晋升情况--组件
  import professionalSkill from './teachersManagement_view/teachersManagement_view_professionalSkill.vue';
  //  引入--资格证书取得情况--组件
  import credentials from './teachersManagement_view/teachersManagement_view_credentials.vue';
  //  引入--教学经历--组件
  import teachingExperience from './teachersManagement_view/teachersManagement_view_teachingExperience.vue';
  //  引入--学习培训情况--组件
  import study from './teachersManagement_view/teachersManagement_view_study.vue';
  //  引入--培训考试、考核情况--组件
  import train from './teachersManagement_view/teachersManagement_view_train.vue';
  //  引入--获奖情况--组件
  import awards from './teachersManagement_view/teachersManagement_view_awards.vue';
  //  引入--科研信息--组件
  import scientific from './teachersManagement_view/teachersManagement_view_scientific.vue';
  //  引入--证件复印件--组件
  import papers from './teachersManagement_view/teachersManagement_view_papers.vue';

  export default {
//    props:['operailityData1'],
    data() {
      return {
        operailityData:{
          id:4
