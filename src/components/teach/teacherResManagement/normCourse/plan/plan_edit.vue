    ...
    <el-form class="editForm" ref="item" v-for="(item,index) in planDtoList" :model="item" :rules="rules" label-width="100px"
      ...
      <fieldset class="nPlanItem">
        ...
        <el-col :span="4" :offset="10" align="right">
          <el-button type="danger" :disabled="planDtoList.length < 2" @click="remove(index)">删除</el-button>
        </el-col>
        <el-col>
        ...
        <el-col>
          <el-form-item label="详细介绍：">
            <el-input v-model="item.remark" type="textarea" :autosize="{ minRows: 2, maxRows: 4}"></el-input>
          </el-form-item>
        </el-col>
        <el-col>
          <el-form-item label="所需道具：">
            <el-input v-model="item.realia" type="textarea" :autosize="{ minRows: 2, maxRows: 4}"></el-input>
          </el-form-item>
        </el-col>
      </fieldset>
    </el-form>
