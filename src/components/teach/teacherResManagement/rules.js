...
let videoBank = {
  ...
  viewNum: [{ required: true, message: '此项不能为空'},baseRules.greaterThanZero2,baseRules.inputLen(0,20)],  //播放次数
...
let resLiterature = {
  ...
  tags: [baseRules.inputLen(0,50),baseRules.illegalChar()],  //标签
  viewNum: [{ required: true, message: '此项不能为空'},baseRules.greaterThanZero2,baseRules.inputLen(0,20)],  //浏览次数
