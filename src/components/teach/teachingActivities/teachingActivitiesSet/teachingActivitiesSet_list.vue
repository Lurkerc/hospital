...
<template>
  <div id="content"  ref="content">
    ...
    <Modal
      ...
      <operate v-if="publishModal" :type="'publish'" :operateUrl="url.teachctivityRelase" @operate="subCallback" @cancel="cancel" :operaility-data="operailityData"></operate>
      <div slot="footer"></div>
    </Modal>
    ...
    <Modal
      ...
      <remove v-if="removeModal" :delete-url="url.teachctivityRemove" @remove="subCallback" @cancel="cancel" :operaility-data="operailityData"></remove>
