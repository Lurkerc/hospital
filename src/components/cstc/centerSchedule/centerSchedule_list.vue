  ...
  <div>
    <el-form label-width="80px" :inline="true" :model="formValidate" ref="formValidate" :rules="rules">
      ...
      <el-form-item label="时间：" prop="startTime">
        <el-time-select placeholder="起始时间" v-model="formValidate.startTime" :picker-options="{start: '06:30',step: '00:05',end: '22:00'}">
        </el-time-select>
      </el-form-item>
      <el-form-item label-width="0" prop="endTime">
        <el-time-select placeholder="结束时间" v-model="formValidate.endTime" :picker-options="{ start: formValidate.startTime || '06:30',step: '00:05', end: '22:30'}"></el-time-select>
      </el-form-item>
      <el-form-item>
