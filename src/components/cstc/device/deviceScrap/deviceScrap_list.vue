  ...
  <div>
    ...
    <el-form :inline="true" :model="searchObj" ref="searchObj" label-width="86px" class="el-form-item-search" style="margin-top:10px">
      ...
      <el-form-item label="报废时间：" prop="scrapStartTime">
        <el-date-picker v-model="searchObj.scrapStartTime" :editable="false" type="date" placeholder="选择日期时间"></el-date-picker>
        <span>-</span>
        <el-date-picker v-model="searchObj.scrapEndTime" :editable="false" type="date" placeholder="选择日期时间"></el-date-picker>
      </el-form-item>
      <el-form-item>
