<template>
  ...
  <div id="nosocomial" ref="nosocomial">
        ...
        <el-table-column type="expand">
          <template scope="props">
            <template v-if="props.row.deviceList && props.row.deviceList.length > 0">
              <keep-alive>
                <!-- 更多数据 -->
                <device-storage-more-info :rowData="props.row.deviceList" @edit="subCallback"></device-storage-more-info>
              </keep-alive>
            </template>
    ...
    <Modal :mask-closable="false" v-model="leadinModal" height="200" title="对话框标题" class-name="vertical-center-modal" :width="800">
      ...
      <leadin v-if="leadinModal" :id="depId" :url="api" @cancel="cancel" @toChannel="subCallback" :operaility-data="operailityData"
