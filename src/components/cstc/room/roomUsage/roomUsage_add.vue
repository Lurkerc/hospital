        ...
        <el-col :span="8" :offset="2">
          <el-form-item label="使用类型：" prop="employType" required>
            <el-select v-model="formValidate.employType" placeholder="请选择">
              <el-option v-for="item in employTypeOption" v-if="item.value!==''" :key="item.value" :label="item.label" :value="item.value">
              </el-option>
            </el-select>
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col :span="8" :offset="2">
          <el-form-item label="开始时间：" prop="startTime" required>
            <el-date-picker v-model="formValidate.startTime" :editable="false" type="datetime" placeholder="选择日期时间">
            </el-date-picker>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="8" :offset="2">
          <el-form-item label="结束时间：" prop="endTime" required>
            <el-date-picker v-model="formValidate.endTime" :editable="false" type="datetime" placeholder="选择日期时间">
            </el-date-picker>
          </el-form-item>
        </el-col>
      </el-row>
