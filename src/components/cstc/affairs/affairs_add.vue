<template>
  <!--事项增加-->
  <div>
    <el-form :model="formValidate" ref="formValidate" :rules="this.$store.state.rules.Sx" class="demo-form-inline" label-width="90px">
      ...
      <el-row>
        ...
        <el-col :span="10" :offset="2">
          <el-form-item label="事项类型" prop="identify">
      ...
      <el-row>
        ...
        <el-col :span="10" :offset="2">
          <el-form-item label="联系人" prop="resource">
            <el-input size="small" v-model="formValidate.name" placeholder="请输入"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        ...
        <el-col :span="10" :offset="2">
          <el-form-item label="指导老师" prop="resource">
            <el-input size="small" v-model="formValidate.name" placeholder="请输入"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        ...
        <el-col :span="10" :offset="2">
          <el-form-item label="结束时间" prop="resource">
            <el-input size="small" v-model="formValidate.name" placeholder="请输入"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
