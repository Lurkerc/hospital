<template>
  ...
  <div id="content" ref="content" class="modal">
    ...
    <div>
      ...
      <!--删除弹窗-->
      <Modal :mask-closable="false" close-on-click-modal="false" height="200" v-model="removeModal" title="对话框标题" class-name="vertical-center-modal" :width="500">
      ...
      <!---->
      <!--导入弹窗-->
      <Modal :mask-closable="false" close-on-click-modal="false" height="200" v-model="toChannelModal" title="对话框标题" class-name="vertical-center-modal" :width="800">
      ...
      <!---->
      <!--导出弹窗-->
      <Modal :mask-closable="false" close-on-click-modal="false" height="200" v-model="deriveModal" title="对话框标题" class-name="vertical-center-modal" :width="500">
      ...
      <!---->
      <!--短信通知弹窗-->
      <Modal :mask-closable="false" close-on-click-modal="false" height="200" v-model="shortNoteModal" title="对话框标题" class-name="vertical-center-modal" :width="800">
