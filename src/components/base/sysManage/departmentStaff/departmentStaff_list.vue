...
<template>
  <layout-tree>
    ...
    <!-- 住院医人员管理 -->
    <zyy-content v-if="viewTypes === 'ZYY'" slot="right" :deptId="deptId" :fromWhereTree="fromWhereTree"></zyy-content>
    <!-- 默认部门人员管理 -->
    <dep-content v-else slot="right" :deptId="deptId" :fromWhereTree="fromWhereTree"></dep-content>
  </layout-tree>
</template>
<style>
  .el-select .el-input {
