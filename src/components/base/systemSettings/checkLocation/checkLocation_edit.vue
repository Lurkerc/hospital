    ...
    <el-form ref="formValidate" class="demo-form-inline" label-width="110px" >
            ...
            <el-col :span="24" >
              <el-form-item label="可打卡对象" prop="name9">
                <el-radio-group v-model="setType">
                  ...
                  <el-row>
                    <el-col :span="24">
                      <div class="col-item" style="line-height: 30px"><el-radio :label="'ALL'">所有人</el-radio></div>
                    </el-col>
                  </el-row>
                  <el-row>
                    <el-col :span="24">
                  ...
                  <search-select v-if="formValidate.setType=='ROLE'" @setSltOptionValue="setSltRoles" :selectOptions="selectOptions"></search-select>
                </el-radio-group>
              </el-form-item>
            </el-col>
          </el-row>
      ...
      <el-radio-group v-model="effectiveType" style="display: block;">
        <el-row>
          ...
          <el-col :span="4">
            <div class="col-item"><el-radio :label="'ALL'">所有有效时间</el-radio></div>
          </el-col>
          <el-col :span="3" :offset="1">
            <div class="col-item">
          ...
          <el-col :span="1">
            <div class="col-item" style="text-align: center" v-if="formValidate.effectiveType=='GIVEN'">到&nbsp;&nbsp;</div>
          </el-col>
          <el-col :span="5">
            <div class="col-item" v-if="formValidate.effectiveType=='GIVEN'">
              <el-date-picker
