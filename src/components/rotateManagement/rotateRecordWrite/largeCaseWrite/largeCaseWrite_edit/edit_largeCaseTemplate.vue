                ...
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="平时一般健康情况:" prop="cjwsYbjkqk" >
                      <el-input @keydown.native="keydown('cjwsYbjkqk',$event)" type="textarea" v-model="formValidate.cjwsYbjkqk"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="传染病史:" prop="cjwsCrbs" >
                      <el-input @keydown.native="keydown('cjwsCrbs',$event)" type="textarea" v-model="formValidate.cjwsCrbs"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="手术外伤史:" prop="cjwsSswss" >
                      <el-input @keydown.native="keydown('cjwsSswss',$event)" type="textarea" v-model="formValidate.cjwsSswss"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="药物过敏史:" prop="cjwsYwgms" >
                      <el-input @keydown.native="keydown('cjwsYwgms',$event)" type="textarea" v-model="formValidate.cjwsYwgms"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
              </el-collapse-item>
                ...
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="呼吸系统:" prop="cxthgHxxt" >
                      <el-input @keydown.native="keydown('cxthgHxxt',$event)" type="textarea" v-model="formValidate.cxthgHxxt"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="循环系统:" prop="cxthgXuhxt" >
                      <el-input @keydown.native="keydown('cxthgXuhxt',$event)" type="textarea" v-model="formValidate.cxthgXuhxt"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="消化系统:" prop="cxthgXihxt" >
                      <el-input @keydown.native="keydown('cxthgXihxt',$event)" type="textarea" v-model="formValidate.cxthgXihxt"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="泌尿系统:" prop="cxthgMlxt" >
                      <el-input @keydown.native="keydown('cxthgMlxt',$event)" type="textarea" v-model="formValidate.cxthgMlxt"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="血液系统:" prop="cxthgXyxt" >
                      <el-input @keydown.native="keydown('cxthgXyxt',$event)" type="textarea" v-model="formValidate.cxthgXyxt"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="内分泌系统:" prop="cxthgNfmxt" >
                      <el-input @keydown.native="keydown('cxthgNfmxt',$event)" type="textarea" v-model="formValidate.cxthgNfmxt"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="神经系统:" prop="cxthgSjxt1" >
                      <el-input @keydown.native="keydown('cxthgSjxt1',$event)" type="textarea" v-model="formValidate.cxthgSjxt1"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="生殖系统:" prop="cxthgSzxt" >
                      <el-input @keydown.native="keydown('cxthgSzxt',$event)" type="textarea" v-model="formValidate.cxthgSzxt"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="肌肉骨关节系统:" prop="cxthgGgjxt" >
                      <el-input @keydown.native="keydown('cxthgGgjxt',$event)" type="textarea" v-model="formValidate.cxthgGgjxt"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="个人史:" prop="cxthgGrs" >
                      <el-input @keydown.native="keydown('cxthgGrs',$event)" type="textarea" v-model="formValidate.cxthgGrs"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="月经婚育史:" prop="cxthgYjhys" >
                      <el-input @keydown.native="keydown('cxthgYjhys',$event)" type="textarea" v-model="formValidate.cxthgYjhys"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="家庭史:" prop="cxthgJts" >
                      <el-input @keydown.native="keydown('cxthgJts',$event)" type="textarea" v-model="formValidate.cxthgJts"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
              </el-collapse-item>
                      ...
                      <el-row >
                        <el-col :span="3">
                          <el-form-item label="T:" prop="ctgjcSmtzT" label-width="50px">
                            <el-input @keydown.native="keydown('ctgjcSmtzT',$event)" style="width:100px;"  v-model="formValidate.ctgjcSmtzT"></el-input>
                          </el-form-item>
                        </el-col>
                        <el-col :span="3">
                          <el-form-item label="C:" prop="ctgjcSmtzC" label-width="50px">
                            <el-input @keydown.native="keydown('ctgjcSmtzC',$event)" style="width:100px;"  v-model="formValidate.ctgjcSmtzC"></el-input>
                          </el-form-item>
                        </el-col>
                        <el-col :span="3">
                          <el-form-item label="P:" prop="ctgjcSmtzP" label-width="50px">
                            <el-input  @keydown.native="keydown('ctgjcSmtzP',$event)" style="width:100px;"  v-model="formValidate.ctgjcSmtzP"></el-input>
                          </el-form-item>
                        </el-col>
                        <el-col :span="3">
                          <el-form-item label="	次/分:" prop="ctgjcSmtzCf1" label-width="50px">
                            <el-input @keydown.native="keydown('ctgjcSmtzCf1',$event)" style="width:100px;"  v-model="formValidate.ctgjcSmtzCf1"></el-input>
                          </el-form-item>
                        </el-col>
                        <el-col :span="3">
                          <el-form-item label="R:" prop="ctgjcSmtzR" label-width="50px">
                            <el-input @keydown.native="keydown('ctgjcSmtzR',$event)" style="width:100px;"  v-model="formValidate.ctgjcSmtzR"></el-input>
                          </el-form-item>
                        </el-col>
                        <el-col :span="3">
                          <el-form-item label="	次/分:" prop="ctgjcSmtzCf2" label-width="50px">
                            <el-input @keydown.native="keydown('ctgjcSmtzCf2',$event)" style="width:100px;"  v-model="formValidate.ctgjcSmtzCf2"></el-input>
                          </el-form-item>
                        </el-col>
                        <el-col :span="3">
                          <el-form-item label="BP:" prop="ctgjcSmtzBp" label-width="50px">
                            <el-input @keydown.native="keydown('ctgjcSmtzBp',$event)" style="width:100px;"  v-model="formValidate.ctgjcSmtzBp"></el-input>
                          </el-form-item>
                        </el-col>
                        <el-col :span="3">
                          mmHg(kPa)
                ...
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="一般情况:" prop="ctgjcYbqk1" >
                      <el-input @keydown.native="keydown('ctgjcYbqk1',$event)" type="textarea" v-model="formValidate.ctgjcYbqk1"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="皮肤粘膜:" prop="ctgjcPfnm" >
                      <el-input @keydown.native="keydown('ctgjcPfnm',$event)" type="textarea" v-model="formValidate.ctgjcPfnm"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="浅表淋巴结:" prop="ctgjcQblbj" >
                      <el-input @keydown.native="keydown('ctgjcQblbj',$event)" type="textarea" v-model="formValidate.ctgjcQblbj"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="头部及其器官:" prop="ctgjcTbqg" >
                      <el-input @keydown.native="keydown('ctgjcTbqg',$event)" type="textarea" v-model="formValidate.ctgjcTbqg"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="颈部:" prop="ctgjcJb" >
                      <el-input @keydown.native="keydown('ctgjcJb',$event)" type="textarea" v-model="formValidate.ctgjcJb"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="胸部:" prop="ctgjcXb" >
                      <el-input @keydown.native="keydown('ctgjcXb',$event)" type="textarea" v-model="formValidate.ctgjcXb"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="胸廊:" prop="ctgjcXl" >
                      <el-input @keydown.native="keydown('ctgjcXl',$event)" type="textarea" v-model="formValidate.ctgjcXl"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="乳腺:" prop="ctgjcRx" >
                      <el-input @keydown.native="keydown('ctgjcRx',$event)" type="textarea" v-model="formValidate.ctgjcRx"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="肺:" prop="ctgjcFei" >
                      <el-input @keydown.native="keydown('ctgjcFei',$event)" type="textarea" v-model="formValidate.ctgjcFei"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="视诊:" prop="ctgjcSz1" >
                      <el-input @keydown.native="keydown('ctgjcSz1',$event)" type="textarea" v-model="formValidate.ctgjcSz1"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="触诊:" prop="ctgjcCz1" >
                      <el-input @keydown.native="keydown('ctgjcCz1',$event)" type="textarea" v-model="formValidate.ctgjcCz1"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="叩诊:" prop="ctgjcKz1" >
                      <el-input @keydown.native="keydown('ctgjcKz1',$event)" type="textarea" v-model="formValidate.ctgjcKz1"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="听诊:" prop="ctgjcTz1" >
                      <el-input @keydown.native="keydown('ctgjcTz1',$event)" type="textarea" v-model="formValidate.ctgjcTz1"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="心脏:" prop="ctgjcXz" >
                      <el-input @keydown.native="keydown('ctgjcXz',$event)" type="textarea" v-model="formValidate.ctgjcXz"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="视诊:" prop="ctgjcSz2" >
                      <el-input @keydown.native="keydown('ctgjcSz2',$event)" type="textarea" v-model="formValidate.ctgjcSz2"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="触诊:" prop="ctgjcCz2" >
                      <el-input @keydown.native="keydown('ctgjcCz2',$event)" type="textarea" v-model="formValidate.ctgjcCz2"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;   叩诊：心脏相对浊音界如下况：
                ...
                <el-row>
                  <el-col :span="3" :offset="2">
                    <el-form-item label-width="0" prop="ctgjcKzy1" >
                      <el-input @keydown.native="keydown('ctgjcKzy1',$event)"  v-model="formValidate.ctgjcKzy1"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col  style="text-align: center" :span="3" :offset="2">
                    <div>II</div>
                  ...
                  <el-col :span="3" :offset="2">
                    <el-form-item label-width="0" prop="ctgjcKzz1" >
                      <el-input @keydown.native="keydown('ctgjcKzz1',$event)"  v-model="formValidate.ctgjcKzz1"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="3" :offset="2">
                    <el-form-item label-width="0" prop="ctgjcKzy2" >
                      <el-input  @keydown.native="keydown('ctgjcKzy2',$event)" v-model="formValidate.ctgjcKzy2"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col  style="text-align: center" :span="3" :offset="2">
                    <div>III</div>
                  ...
                  <el-col :span="3" :offset="2">
                    <el-form-item  prop="ctgjcKzz2" label-width="0">
                      <el-input @keydown.native="keydown('ctgjcKzz2',$event)"  v-model="formValidate.ctgjcKzz2"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="3" :offset="2">
                    <el-form-item  prop="ctgjcKzy3" label-width="0">
                      <el-input @keydown.native="keydown('ctgjcKzy3',$event)"  v-model="formValidate.ctgjcKzy3"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col  style="text-align: center" :span="3" :offset="2">
                    <div>IV</div>
                  ...
                  <el-col :span="3" :offset="2">
                    <el-form-item  prop="ctgjcKzz3" label-width="0">
                      <el-input  @keydown.native="keydown('ctgjcKzz3',$event)" v-model="formValidate.ctgjcKzz3"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="3" :offset="2">
                    <el-form-item  prop="ctgjcKzy4" label-width="0">
                      <el-input @keydown.native="keydown('ctgjcKzy4',$event)"  v-model="formValidate.ctgjcKzy4"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col  style="text-align: center" :span="3" :offset="2">
                    <div>V</div>
                  ...
                  <el-col :span="3" :offset="2">
                    <el-form-item  prop="ctgjcKzz4" label-width="0">
                      <el-input @keydown.native="keydown('ctgjcKzz4',$event)"  v-model="formValidate.ctgjcKzz4"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="听诊:" prop="ctgjcTz2" >
                      <el-input @keydown.native="keydown('ctgjcTz2',$event)" type="textarea" v-model="formValidate.ctgjcTz2"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="桡动脉:" prop="ctgjcRdm" >
                      <el-input @keydown.native="keydown('ctgjcRdm',$event)" type="textarea" v-model="formValidate.ctgjcRdm"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="周围血管征:" prop="ctgjcZwxg">
                      <el-input @keydown.native="keydown('ctgjcZwxg',$event)" type="textarea" v-model="formValidate.ctgjcZwxg"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="腹部:" prop="ctgjcFb" >
                      <el-input @keydown.native="keydown('ctgjcFb',$event)" type="textarea" v-model="formValidate.ctgjcFb"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="视诊:" prop="ctgjcSz3" >
                      <el-input @keydown.native="keydown('ctgjcSz3',$event)" type="textarea" v-model="formValidate.ctgjcSz3"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="触诊:" prop="ctgjcCz3" >
                      <el-input @keydown.native="keydown('ctgjcCz3',$event)" type="textarea" v-model="formValidate.ctgjcCz3"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="一般情况:" prop="ctgjcYbqk2" >
                      <el-input  @keydown.native="keydown('ctgjcYbqk2',$event)" type="textarea" v-model="formValidate.ctgjcYbqk2"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="肝脏:" prop="ctgjcGz" >
                      <el-input @keydown.native="keydown('ctgjcGz',$event)" type="textarea" v-model="formValidate.ctgjcGz"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="脾脏:" prop="ctgjcPz" >
                      <el-input @keydown.native="keydown('ctgjcPz',$event)" type="textarea" v-model="formValidate.ctgjcPz"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="肾脏:" prop="ctgjcSz" >
                      <el-input @keydown.native="keydown('ctgjcSz',$event)" type="textarea" v-model="formValidate.ctgjcSz"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="其他:" prop="ctgjcQt" >
                      <el-input @keydown.native="keydown('ctgjcQt',$event)" type="textarea" v-model="formValidate.ctgjcQt"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="叩诊:" prop="ctgjcKz3" >
                      <el-input @keydown.native="keydown('ctgjcKz3',$event)" type="textarea" v-model="formValidate.ctgjcKz3"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="听诊:" prop="ctgjcTz3" >
                      <el-input @keydown.native="keydown('ctgjcTz3',$event)" type="textarea" v-model="formValidate.ctgjcTz3"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="肛门、直肠:" prop="ctgjcGzc" >
                      <el-input @keydown.native="keydown('ctgjcGzc',$event)" type="textarea" v-model="formValidate.ctgjcGzc"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="外生殖器:" prop="ctgjcWszq" >
                      <el-input @keydown.native="keydown('ctgjcWszq',$event)" type="textarea" v-model="formValidate.ctgjcWszq"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="脊柱:" prop="ctgjcJz" >
                      <el-input @keydown.native="keydown('ctgjcJz',$event)" type="textarea" v-model="formValidate.ctgjcJz"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="四肢:" prop="ctgjcShiz" >
                      <el-input @keydown.native="keydown('ctgjcShiz',$event)" type="textarea" v-model="formValidate.ctgjcShiz"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="神经系统:" prop="ctgjcSjxt2" >
                      <el-input @keydown.native="keydown('ctgjcSjxt2',$event)" type="textarea" v-model="formValidate.ctgjcSjxt2"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="专科情况:" prop="ctgjcZkqk" >
                      <el-input @keydown.native="keydown('ctgjcZkqk',$event)" type="textarea" v-model="formValidate.ctgjcZkqk"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="实验室及特殊检查:" prop="ctgjcSysjc" >
                      <el-input @keydown.native="keydown('ctgjcSysjc',$event)" type="textarea" v-model="formValidate.ctgjcSysjc"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
              </el-collapse-item>
