                      ...
                      <el-row >
                        <el-col :span="3">
                          <el-form-item label="T:" prop="ctgjcSmtzT" label-width="50px">
                            <el-input @keydown.native="keydown('ctgjcSmtzT',$event)"  @paste.native="contextmenu('ctgjcSmtzT',$event)" style="width:100px;"  v-model="formValidate.ctgjcSmtzT"></el-input>
                          </el-form-item>
                        </el-col>
                        <el-col :span="3">
                          <el-form-item label="C:" prop="ctgjcSmtzC" label-width="50px">
                            <el-input @keydown.native="keydown('ctgjcSmtzC',$event)"  @paste.native="contextmenu('ctgjcSmtzC',$event)" style="width:100px;"  v-model="formValidate.ctgjcSmtzC"></el-input>
                          </el-form-item>
                        </el-col>
                        <el-col :span="3">
                          <el-form-item label="P:" prop="ctgjcSmtzP" label-width="50px">
                            <el-input  @keydown.native="keydown('ctgjcSmtzP',$event)"  @paste.native="contextmenu('ctgjcSmtzP',$event)" style="width:100px;"  v-model="formValidate.ctgjcSmtzP"></el-input>
                          </el-form-item>
                        </el-col>
                        <el-col :span="3">
                          <el-form-item label="	次/分:" prop="ctgjcSmtzCf1" label-width="50px">
                            <el-input @keydown.native="keydown('ctgjcSmtzCf1',$event)"  @paste.native="contextmenu('ctgjcSmtzCf1',$event)" style="width:100px;"  v-model="formValidate.ctgjcSmtzCf1"></el-input>
                          </el-form-item>
                        </el-col>
                        <el-col :span="3">
                          <el-form-item label="R:" prop="ctgjcSmtzR" label-width="50px">
                            <el-input @keydown.native="keydown('ctgjcSmtzR',$event)"  @paste.native="contextmenu('ctgjcSmtzR',$event)" style="width:100px;"  v-model="formValidate.ctgjcSmtzR"></el-input>
                          </el-form-item>
                        </el-col>
                        <el-col :span="3">
                          <el-form-item label="	次/分:" prop="ctgjcSmtzCf2" label-width="50px">
                            <el-input @keydown.native="keydown('ctgjcSmtzCf2',$event)"  @paste.native="contextmenu('ctgjcSmtzCf2',$event)" style="width:100px;"  v-model="formValidate.ctgjcSmtzCf2"></el-input>
                          </el-form-item>
                        </el-col>
                        <el-col :span="3">
                          <el-form-item label="BP:" prop="ctgjcSmtzBp" label-width="50px">
                            <el-input @keydown.native="keydown('ctgjcSmtzBp',$event)"  @paste.native="contextmenu('ctgjcSmtzBp',$event)" style="width:100px;"  v-model="formValidate.ctgjcSmtzBp"></el-input>
                          </el-form-item>
                        </el-col>
                        <el-col :span="3">
                            mmHg(kPa)
                ...
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="胸廊:" prop="ctgjcXl" >
                      <el-input @keydown.native="keydown('ctgjcXl',$event)"  @paste.native="contextmenu('ctgjcXl',$event)" type="textarea" v-model="formValidate.ctgjcXl"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="乳腺:" prop="ctgjcRx" >
                      <el-input @keydown.native="keydown('ctgjcRx',$event)"  @paste.native="contextmenu('ctgjcRx',$event)" type="textarea" v-model="formValidate.ctgjcRx"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="肺:" prop="ctgjcFei" >
                      <el-input @keydown.native="keydown('ctgjcFei',$event)"  @paste.native="contextmenu('ctgjcFei',$event)" type="textarea" v-model="formValidate.ctgjcFei"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                ...
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="心脏:" prop="ctgjcXz" >
                      <el-input @keydown.native="keydown('ctgjcXz',$event)"  @paste.native="contextmenu('ctgjcXz',$event)" type="textarea" v-model="formValidate.ctgjcXz"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                ...
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="腹部:" prop="ctgjcFb" >
                      <el-input @keydown.native="keydown('ctgjcFb',$event)"  @paste.native="contextmenu('ctgjcFb',$event)" type="textarea" v-model="formValidate.ctgjcFb"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                ...
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="一般情况:" prop="ctgjcYbqk2" >
                      <el-input  @keydown.native="keydown('ctgjcYbqk2',$event)"  @paste.native="contextmenu('ctgjcYbqk2',$event)" type="textarea" v-model="formValidate.ctgjcYbqk2"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="肝脏:" prop="ctgjcGz" >
                      <el-input @keydown.native="keydown('ctgjcGz',$event)"  @paste.native="contextmenu('ctgjcGz',$event)" type="textarea" v-model="formValidate.ctgjcGz"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="脾脏:" prop="ctgjcPz" >
                      <el-input @keydown.native="keydown('ctgjcPz',$event)"  @paste.native="contextmenu('ctgjcPz',$event)" type="textarea" v-model="formValidate.ctgjcPz"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="肾脏:" prop="ctgjcSz" >
                      <el-input @keydown.native="keydown('ctgjcSz',$event)"  @paste.native="contextmenu('ctgjcSz',$event)" type="textarea" v-model="formValidate.ctgjcSz"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="其他:" prop="ctgjcQt" >
                      <el-input @keydown.native="keydown('ctgjcQt',$event)"  @paste.native="contextmenu('ctgjcQt',$event)" type="textarea" v-model="formValidate.ctgjcQt"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
                ...
                <el-row >
                  <el-col :span="24" >
                    <el-form-item label="四肢:" prop="ctgjcShiz" >
                      <el-input @keydown.native="keydown('ctgjcShiz',$event)"  @paste.native="contextmenu('ctgjcShiz',$event)" type="textarea" v-model="formValidate.ctgjcShiz"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row >
