      ...
      <el-table align="center" :context="self" :height="dynamicHt" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" width="140">
          ...
          <template scope="scope">
            ...
            <el-button :disabled="!canRotary(scope.row) && scope.row.graduateAppraisalState==='USER_NOT_REPORT'" size="small" type="success" @click="rotary(scope.row)">出科</el-button>
          </template>
        </el-table-column>
        ...
        <el-table-column label="技能考核成绩" prop="skillScore" width="120px">
          <template scope="scope">
            ...
            <el-button type="info" size="mini" @click="skill(scope.row)" v-if="!isManage && scope.row.skillScore && scope.row.skillIsMakeup">补考</el-button>
          </template>
        </el-table-column>
