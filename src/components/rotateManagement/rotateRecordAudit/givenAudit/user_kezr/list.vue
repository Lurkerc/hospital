      ...
      <el-table align="center" :context="self" :height="dynamicHt" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" width="140" align="center">
          <template scope="scope">
            ...
            <el-button :disabled="!scope.row.depExaminationId && scope.row.graduateAppraisalState==='EDU_NOT_REPORT'" size="small" type="success" @click="rotary(scope.row)">审核</el-button>
