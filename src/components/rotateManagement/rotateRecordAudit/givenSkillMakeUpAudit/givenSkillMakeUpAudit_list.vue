      ...
      <el-table ref="multipleTable" align="center" :height="dynamicHt" :context="self" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column label="操作" align="center" width="80">
          <template scope="scope">
            <el-button v-if="scope.row.examState === 'NO_AUDIT'" size="small" type="success" @click="add(scope.row)">审核</el-button>
            <el-button v-else size="small" type="info" @click="show(scope.row)">查看</el-button>
          </template>
        </el-table-column>
